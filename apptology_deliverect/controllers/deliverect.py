    ...
    def receive_pos_order(self):
        ...
        try:
            ...
            if data['status'] == 100 and data['_id']:
                ...
                self.generate_order_notification()
                return Response(
